...
set ylabel 'r/G' font ",25" offset -4,0,0 rotate by 0
#set key font ",30" tamanho da label dentro da figura

#splot "matrizC.dat" u ($1/100.):(($2/10+2.4)/5):3 matrix with pm3d

splot "matrizP.dat" u ($1/100.):(($2/10+2.4)/5):3 matrix with pm3d, "temp_f.dat" u 1:2:(0) notitle with lines lw 1 lc -1, "reta4.dat" u 1:2:(0) w l lw 1 lc -1
