...
set xtics font ",25" offset 0,-.5,0
set ytics font ",25"  
unset key
set xlabel 'Time' rotate by 0 font ",30" offset 0,-1.5,0
set ylabel '{/Symbol r}' rotate by 0 font ",30" offset -2,0,0
set xrange[1:5000]
set yrange[0:1]
set logscale x
...
plot 'r4g015a3.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,'r4g015a4.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015a5.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015a6.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015a7.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015a8.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015a9.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015a.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015a1.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6, 'r4g015_media' u 1:($2+$4) w l lt 8 lw 6
