...
set ylabel '{/Symbol r}' rotate by 0 font ",50" offset -4,0,0
set xrange[1:5000]
set yrange[0:1.05]
set logscale x

set label 1 "(b)" font ",50" at 2,0.9 front
...
plot 'r4g011a3.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a4.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a5.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a6.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a7.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a8.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a9.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011a1.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g011_media.txt' u 1:($2+$4) w l lt 8 lw 8
