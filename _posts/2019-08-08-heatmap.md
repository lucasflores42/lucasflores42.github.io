...
Code to create a heatmap from a file with a matrix generated from <code class="language-plaintext highlighter-rouge">transf_matrix.awk</code>.
...
pause -1
```
[Download file](/files/scripts/data_analysis/heatmap.gp){:download}