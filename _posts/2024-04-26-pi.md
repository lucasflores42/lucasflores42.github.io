...
services:
  ...
  nextcloud:
    ...
    ports:
      - 8080:80
    volumes:
      - /path/nextcloud_data:/var/www/html
    links:
      - db
    environment:
      - MYSQL_PASSWORD=
  ...
  jellyfin:
    ...
    volumes:
      - /path/jellyfin_data/config:/config
      - /path/jellyfin_data/videos:/data/videos
      - /path/jellyfin_data/music:/data/music
    ports:
      - 8096:8096
    restart: unless-stopped    
