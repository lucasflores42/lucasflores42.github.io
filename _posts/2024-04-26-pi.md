...
The goal of this post is to show my Raspberry Pi setup. I use a Raspberr 4 4GB mainly as a self-hosted server with Nextcloud to replace Google Drive. 
...
The pi imager asks for the wifi settings, so this step is no necessary.
