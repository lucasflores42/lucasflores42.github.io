...
raspberry  ![Alt Text](/commons/pi.jpg)


	intall raspberry OS 64bit lite on SSD (dont forget to enable ssh)
	pimoroni/fanshim-python
	
	config wifi (wpa_supplicant.conf, use notapad++)
		DONT USE BOOKWORM OS, USE BULLEYE
