...
set label 1 "(c)" font ",50" at 1800, 0.15 front
...
plot 'r4g06a3.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a4.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a5.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a6.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a7.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a8.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a9.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06a1.txt' u 1:($2+$4) w l lc rgb 'gray60' lw 6,\
     'r4g06_media' u 1:($2+$4) w l lt 8 lw 6
